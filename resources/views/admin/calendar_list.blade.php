    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <table id="calendar-table" class="table table-bordered table-paginate" cellspacing="0"
                       width="100%">
                    <thead>
                    <tr>
                        <th>No</th>
...
@push('script_extend')
    ...
    <script>
        ...
        $(document).ready(function () {
            var dt = $('#calendar-table').DataTable({
                "processing": true,
                "serverSide": false,
                "ajax": "{{route('calendar.get')}}" ,
                "columns": [
                    {
                        "data": "id",
                    ...
                    {"data": "action",
                        "render": function(data, type, row) {
                            return "<span class='btn btn-primary btn-fw m-0 text-white' style='line-height: 20px' onclick=window.location.href='/calendar/detail/" + row.id_projects + "'> View</span>"
                        },
                    },
                ],
                "order": [[1, 'asc']]
