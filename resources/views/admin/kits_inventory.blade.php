        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-sm-flex justify-content-between align-items-start mb-3">
                    ...
                    <div>
                        <a class="btn btn-block btn-danger text-white" href="/inventory/kits/download" target="_blank">Download
                            Report</a>
                        ...
                        @foreach ($kits as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/inventory/kits/detail/{{ $item->id }}" class=""><i
                                            class="icon-sm mdi mdi-eye text-success"></i></a>
                                    <a href="/inventory/kits/edit/{{ $item->id }}" class="px-2"><i
