        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-sm-flex justify-content-between align-items-start">
                    ...
                    <div>
                        <a class="btn btn-block btn-danger text-white" href="/inventory/drone/download" target="_blank">Download
                            Report</a>
                        ...
                        @foreach ($drone as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/inventory/drone/detail/{{ $item->id }}" class=""><i
                                            class="icon-sm mdi mdi-eye text-success"></i></a>
                                    <a href="/inventory/drone/edit/{{ $item->id }}" class="px-2"><i
