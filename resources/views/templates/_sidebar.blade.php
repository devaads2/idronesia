<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        @can('pilot')
            <li class="nav-item">
                <a class="nav-link" href="/checklist-before">
                    <i class="menu-icon mdi mdi-airplane-takeoff"></i>
                    <span class="menu-title">Pre Flight Checklist</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/checklist-after">
                    <i class="menu-icon mdi mdi-airplane-landing"></i>
                    <span class="menu-title">Post Flight Checklist</span>
                </a>
            </li>
        @endcan
